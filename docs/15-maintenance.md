...
## Bilinen sorunlar
Kod bağımsız denetimden geçmedi (Blocker/Critical kapısı bu profilde yok, DL kaydı: profil kararı 2026-07-26). Runtime davranışında bilinen hata yok — 25/25 test yeşil, coverage %98.6.
...
| TD-3 | Ayrı E2E/gerçek-tarayıcı testi yok, yalnız fake-dom entegrasyon testleri | DL-11-001 | P3 | Görsel/DPR render doğruluğu otomatik kapsam dışı; manuel smoke ile telafi |
